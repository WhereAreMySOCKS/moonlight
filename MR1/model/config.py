...
_C.MODEL.PRETRAIN_CKPT = r'/home/guoshipeng/moonlight/MR1/data1/pretrain_model/swin_tiny/swin_tiny_patch4_window7_224_22k.pth'
_C.MODEL.RESUME = ''
...
def update_config(config, args):
    _update_config_from_file(config, args.cfg)##是否预训练
