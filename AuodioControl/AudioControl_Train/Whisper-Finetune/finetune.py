...
add_arg("base_model",    type=str, default="../speech_recognition/model/whisper-tiny", help="Whisper的基础模型")
add_arg("output_dir",    type=str, default="save_model/",                  help="训练保存模型的路径")
...
def main():
    ...
    trainer.save_state()
    if training_args.local_rank == 0 or training_args.local_rank == -1:
        model.save_pretrained(os.path.join(output_dir, "whisper-base-chinese"))
